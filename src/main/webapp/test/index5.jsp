...
#canvas {
	...
	z-index: -1;
	background:#FF0000 url(img/bg.png) no-repeat;
}
...
检修轴承数据采集分析系统
	...
	<div style="height: 62px; background: #04629b;">
		...
		<a id="query" href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="showWash();">清洗机</a>
		<a id="query" href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="showRun();">跑合台</a>
	</div>
	<div id="canvas" />
	<!-- 弹出框 -->
								...
								$("#RUN0" + attr)
										.click(
												function() {
													...
													//选中边框变色
													$("#RUN0" + attr).css({border : "2px solid #9899a7"});
